                                    ...
                                    <div className="ml-10 flex items-baseline space-x-4">
                                        ...
                                        <div className="dropdown relative ">
                                            ...
                                            <div className="dropdown-menu absolute hidden">
                                                <ul
                                                    className={color ? " flex flex-col space-y-4 rounded-lg  bg-red-900 bg-opacity-80 p-2 text-center font-bold text-white md:text-base lg:text-lg transition duration-700 ease-in-out" : " flex flex-col space-y-4 rounded-lg  bg-black bg-opacity-80 p-2 text-center font-bold text-white md:text-base lg:text-lg transition duration-700 ease-in-out"}
                                                    aria-labelledby="dropdownMenuButton1"
                                                >
                                                    <li className="rounded-lg transition  hover:text-yellow-500 ">
                                                        <Link
